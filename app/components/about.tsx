  ...
  return (
    <section id="about" className="py-20 relative" style={{ backgroundColor: "#212529" }}>
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-1/3 right-1/3 w-64 h-64 rounded-full opacity-20 filter blur-[100px]" style={{ backgroundColor: "#00B4D8" }}></div>
        <div className="absolute bottom-1/3 left-1/3 w-72 h-72 rounded-full opacity-20 filter blur-[120px]" style={{ backgroundColor: "#00B4D8" }}></div>
      </div>
